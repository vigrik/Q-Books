<?php     
    ...
    if(!$flag){//Если книги нет в избранных книгах
        echo "Книги с введенным id нету в избранном";
        exit;
    }
     ...
     */
    if($database -> postDeleteList($id, $_GET['uid'], 'favorite', $db)){//Удаляет из базы данных
        echo "Книга успешно удалена из избранных";
    }
?>